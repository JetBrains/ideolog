...
class LogHeavyFilterService(project: Project) {

  companion object {
    fun getInstance(project: Project): LogHeavyFilterService {
      return ServiceManager.getService(project, LogHeavyFilterService::class.java)
    }
  ...
  private val myAlarm = Alarm(Alarm.ThreadToUse.POOLED_THREAD, project)
